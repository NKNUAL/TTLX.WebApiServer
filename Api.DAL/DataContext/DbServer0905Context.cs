namespace Api.DAL.DataContext
{
    ...
    public partial class DbServer0905Context : DbContext
    {
        public DbServer0905Context()
            : base()
        {
            Database.Connection.ConnectionString = ConfigTools.GetDBConnString("dbServer0905");
        ...
        public virtual DbSet<MockTestPaperRoleRegInfo> MockTestPaperRoleRegInfo { get; set; }
        ...
        public virtual DbSet<SDFDTabletest> SDFDTabletest { get; set; }
        public virtual DbSet<ServerMachineRegInfo> ServerMachineRegInfo { get; set; }
        public virtual DbSet<ServerMachineRegInfo_bak_0810> ServerMachineRegInfo_bak_0810 { get; set; }
        public virtual DbSet<Settlement_Questions_Relation> Settlement_Questions_Relation { get; set; }
        public virtual DbSet<SpecialtyRegInfo> SpecialtyRegInfo { get; set; }
        public virtual DbSet<SpecialtyRenewInfo> SpecialtyRenewInfo { get; set; }
        ...
        public virtual DbSet<V_QuestionsInfo> V_QuestionsInfo { get; set; }
        public virtual DbSet<RenewRecord> RenewRecord { get; set; }
        public virtual DbSet<RenewRecordRelation> RenewRecordRelation { get; set; }
